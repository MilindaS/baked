...
fcViews.year = View.extend({
	...
	computeRange: function(date) {
		...
		//this.intervalDuration = { months: this.nbMonths || 12 };
	...
	buildDayGrids: function() {
		...
		dayGrid.renderDates(view.hasRigidRows()); // call the Grid super-method
	...
	computeMonthRange: function(date) {
		...
		this.intervalDuration = moment.duration(1, 'months');
		var range = View.prototype.computeRange.call(this, date); // get value from the super-method
